...
export function WorkspacePropertiesPanel({ element, onUpdate, onRemove, onEdit }: Props) {
  if (!element) {
    return (
      ...
      {element.type === "artboard" && (
        <>
          <div className="space-y-1.5">
            ...
            <Input
              value={(element as Artboard).name}
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={(element as Artboard).format}
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <Input
                  type="number"
                  value={(element as StickyNote).width}
              ...
              <div>
                ...
                <Input
                  type="number"
                  value={(element as StickyNote).height}
      ...
      {element.type === "text" && (
        <>
          <div className="space-y-1.5">
            ...
            <Input
              value={(element as WorkspaceText).text}
          ...
          <div className="space-y-1.5">
            ...
            <Slider
              value={[(element as WorkspaceText).fontSize]}
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-1.5">
              <Button
                variant={(element as WorkspaceText).bold ? "default" : "outline"}
                size="icon"
                className="h-7 w-7"
              ...
              <Button
                variant={(element as WorkspaceText).italic ? "default" : "outline"}
                size="icon"
                className="h-7 w-7"
      ...
      {element.type === "arrow" && (
        <>
          ...
          <div className="space-y-1.5">
            ...
            <Select
              value={(element as Arrow).direction}
