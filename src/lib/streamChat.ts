...
export async function streamChat({ messages, onDelta, onDone, functionName, extraBody = {} }: StreamChatOptions) {
  ...
  if (resp.status === 402) throw new Error("Créditos insuficientes. Adicione créditos ao workspace.");
